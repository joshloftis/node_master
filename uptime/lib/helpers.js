...
helpers.interpolate = function(str, data) {
  ...
  // Add the templateGloabls in the data object, prepending their key name with "gloabl"
  ...
  // For each key in the data object, insert its value into the string at the corresponding point
  for (let key in data) {
